...
const ProfileSection = ({ user, refreshUserData }) => {
  ...
  const handleShowHistory = async () => {
    ...
    try {
      console.log("Fetching withdrawal history for user:", user.id);
      const history = await getUserWithdrawalHistory(user.id);
      console.log("Withdrawal history received:", history);
          ...
          >
            ...
            <div className="flex-1">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-sky-200 font-semibold transition-all duration-200"
              >
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            <Avatar className="h-28 w-28 border-4 border-gradient-to-r from-blue-500 to-purple-600 shadow-2xl">
              <AvatarImage
                src={
                  user.profilePicUrl ||
              ...
              />
              <AvatarFallback className="bg-gradient-to-br from-blue-600 to-purple-700 text-white text-xl font-bold">
                {fallbackAvatar}
              </AvatarFallback>
            </Avatar>
          ...
          >
            <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-sm p-5 rounded-2xl text-center border border-blue-500/30 hover:border-blue-400/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-sm text-blue-300">STON</p>
            </div>

            <div className="bg-gradient-to-br from-yellow-600/20 to-yellow-800/20 backdrop-blur-sm p-5 rounded-2xl text-center border border-yellow-500/30 hover:border-yellow-400/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
              <div className="flex items-center justify-center mb-2">
                <Zap className="h-6 w-6 text-yellow-400 mr-2" />
                <span className="text-gray-300 font-medium">Energy</span>
              </div>
              <p className="text-2xl font-bold text-white">
                {user.energy || 0}
              </p>
              <p className="text-sm text-yellow-300">Points</p>
            </div>

            <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-sm p-5 rounded-2xl text-center border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
              <div className="flex items-center justify-center mb-2">
                <Users className="h-6 w-6 text-purple-400 mr-2" />
                <span className="text-gray-300 font-medium">Referrals</span>
              </div>
              <p className="text-2xl font-bold text-white">
                {user.referrals || 0}
              </p>
            ...
            <div className="bg-gradient-to-br from-green-600/20 to-green-800/20 backdrop-blur-sm p-5 rounded-2xl text-center border border-green-500/30 hover:border-green-400/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
              <div className="flex items-center justify-center mb-2">
                <CheckCircle2 className="h-6 w-6 text-green-400 mr-2" />
                <span className="text-gray-300 font-medium">Tasks</span>
              </div>
            ...
            {user.wallet ? (
              <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-600/50 rounded-2xl p-4">
                <div className="flex items-center justify-between gap-3">
                  <Wallet className="h-6 w-6 text-blue-400 flex-shrink-0" />
                  <span
                    className="flex-1 font-mono text-white text-center px-2 select-text"
                    title={user.wallet}
                  ...
                  <div className="flex gap-2">
                    <button
                      type="button"
                      className="flex items-center justify-center p-2 rounded-xl bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 transition-all duration-200 active:scale-95"
                    ...
                    <button
                      type="button"
                      className="flex items-center justify-center p-2 rounded-xl bg-red-600/20 hover:bg-red-600/30 border border-red-500/30 transition-all duration-200 active:scale-95"
